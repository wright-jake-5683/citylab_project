...
#include "custom_interfaces/action/detail/go_to_pose__rosidl_typesupport_fastrtps_c.h"
...
using _GoToPose_Goal__ros_msg_type = custom_interfaces__action__GoToPose_Goal;
...
size_t get_serialized_size_custom_interfaces__action__GoToPose_Goal(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GoToPose_Goal__ros_msg_type * ros_message = static_cast<const _GoToPose_Goal__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _GoToPose_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__action__GoToPose_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t max_serialized_size_custom_interfaces__action__GoToPose_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces__action__GoToPose_Goal;
    is_plain =
      (
...
static size_t _GoToPose_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interfaces__action__GoToPose_Goal(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, action, GoToPose_Goal)() {
...
using _GoToPose_Result__ros_msg_type = custom_interfaces__action__GoToPose_Result;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t get_serialized_size_custom_interfaces__action__GoToPose_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GoToPose_Result__ros_msg_type * ros_message = static_cast<const _GoToPose_Result__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__action__GoToPose_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t max_serialized_size_custom_interfaces__action__GoToPose_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interfaces__action__GoToPose_Result;
    is_plain =
      (
...
static size_t _GoToPose_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interfaces__action__GoToPose_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, action, GoToPose_Result)() {
...
using _GoToPose_Feedback__ros_msg_type = custom_interfaces__action__GoToPose_Feedback;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t get_serialized_size_custom_interfaces__action__GoToPose_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GoToPose_Feedback__ros_msg_type * ros_message = static_cast<const _GoToPose_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__action__GoToPose_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t max_serialized_size_custom_interfaces__action__GoToPose_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interfaces__action__GoToPose_Feedback;
    is_plain =
      (
...
static size_t _GoToPose_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interfaces__action__GoToPose_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, action, GoToPose_Feedback)() {
...
// already included above
// #include "custom_interfaces/action/detail/go_to_pose__functions.h"  // goal
...
using _GoToPose_SendGoal_Request__ros_msg_type = custom_interfaces__action__GoToPose_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, custom_interfaces, action, GoToPose_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t get_serialized_size_custom_interfaces__action__GoToPose_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GoToPose_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _GoToPose_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_custom_interfaces__action__GoToPose_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__action__GoToPose_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t max_serialized_size_custom_interfaces__action__GoToPose_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_custom_interfaces__action__GoToPose_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interfaces__action__GoToPose_SendGoal_Request;
    is_plain =
      (
...
static size_t _GoToPose_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interfaces__action__GoToPose_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, action, GoToPose_SendGoal_Request)() {
...
using _GoToPose_SendGoal_Response__ros_msg_type = custom_interfaces__action__GoToPose_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t get_serialized_size_custom_interfaces__action__GoToPose_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GoToPose_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _GoToPose_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__action__GoToPose_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t max_serialized_size_custom_interfaces__action__GoToPose_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interfaces__action__GoToPose_SendGoal_Response;
    is_plain =
      (
...
static size_t _GoToPose_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interfaces__action__GoToPose_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, action, GoToPose_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, action, GoToPose_SendGoal)() {
...
using _GoToPose_GetResult_Request__ros_msg_type = custom_interfaces__action__GoToPose_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t get_serialized_size_custom_interfaces__action__GoToPose_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GoToPose_GetResult_Request__ros_msg_type * ros_message = static_cast<const _GoToPose_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__action__GoToPose_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t max_serialized_size_custom_interfaces__action__GoToPose_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interfaces__action__GoToPose_GetResult_Request;
    is_plain =
      (
...
static size_t _GoToPose_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interfaces__action__GoToPose_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, action, GoToPose_GetResult_Request)() {
...
// already included above
// #include "custom_interfaces/action/detail/go_to_pose__functions.h"  // result
...
using _GoToPose_GetResult_Response__ros_msg_type = custom_interfaces__action__GoToPose_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, custom_interfaces, action, GoToPose_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t get_serialized_size_custom_interfaces__action__GoToPose_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GoToPose_GetResult_Response__ros_msg_type * ros_message = static_cast<const _GoToPose_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_custom_interfaces__action__GoToPose_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__action__GoToPose_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t max_serialized_size_custom_interfaces__action__GoToPose_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_custom_interfaces__action__GoToPose_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interfaces__action__GoToPose_GetResult_Response;
    is_plain =
      (
...
static size_t _GoToPose_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interfaces__action__GoToPose_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, action, GoToPose_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, action, GoToPose_GetResult)() {
...
// already included above
// #include "custom_interfaces/action/detail/go_to_pose__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _GoToPose_FeedbackMessage__ros_msg_type = custom_interfaces__action__GoToPose_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, custom_interfaces, action, GoToPose_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t get_serialized_size_custom_interfaces__action__GoToPose_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GoToPose_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _GoToPose_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_custom_interfaces__action__GoToPose_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__action__GoToPose_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t max_serialized_size_custom_interfaces__action__GoToPose_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_custom_interfaces__action__GoToPose_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interfaces__action__GoToPose_FeedbackMessage;
    is_plain =
      (
...
static size_t _GoToPose_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interfaces__action__GoToPose_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, action, GoToPose_FeedbackMessage)() {
