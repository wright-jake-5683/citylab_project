    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'custom_interfaces.action.GoToPose_Goal')
            logger.debug(
...
class Metaclass_GoToPose_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_interfaces.action.GoToPose_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_GoToPose_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_interfaces.action.GoToPose_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class GoToPose_SendGoal_Request(metaclass=Metaclass_GoToPose_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'custom_interfaces/GoToPose_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['custom_interfaces', 'action'], 'GoToPose_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from custom_interfaces.action._go_to_pose import GoToPose_Goal
...
class Metaclass_GoToPose_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_interfaces.action.GoToPose_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from custom_interfaces.action import _go_to_pose
...
class GoToPose_SendGoal(metaclass=Metaclass_GoToPose_SendGoal):
    from custom_interfaces.action._go_to_pose import GoToPose_SendGoal_Request as Request
    from custom_interfaces.action._go_to_pose import GoToPose_SendGoal_Response as Response
...
class GoToPose_GetResult_Response(metaclass=Metaclass_GoToPose_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'custom_interfaces/GoToPose_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['custom_interfaces', 'action'], 'GoToPose_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from custom_interfaces.action._go_to_pose import GoToPose_Result
...
class Metaclass_GoToPose_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_interfaces.action.GoToPose_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class GoToPose_GetResult(metaclass=Metaclass_GoToPose_GetResult):
    from custom_interfaces.action._go_to_pose import GoToPose_GetResult_Request as Request
    from custom_interfaces.action._go_to_pose import GoToPose_GetResult_Response as Response
...
class Metaclass_GoToPose_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_interfaces.action.GoToPose_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class GoToPose_FeedbackMessage(metaclass=Metaclass_GoToPose_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'custom_interfaces/GoToPose_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['custom_interfaces', 'action'], 'GoToPose_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from custom_interfaces.action._go_to_pose import GoToPose_Feedback
...
class Metaclass_GoToPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_interfaces.action.GoToPose')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class GoToPose(metaclass=Metaclass_GoToPose):
    ...
    from custom_interfaces.action._go_to_pose import GoToPose_Goal as Goal
    # The result message defined in the action definition.
    from custom_interfaces.action._go_to_pose import GoToPose_Result as Result
    # The feedback message defined in the action definition.
    from custom_interfaces.action._go_to_pose import GoToPose_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from custom_interfaces.action._go_to_pose import GoToPose_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from custom_interfaces.action._go_to_pose import GoToPose_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from custom_interfaces.action._go_to_pose import GoToPose_FeedbackMessage as FeedbackMessage
